...
$layout_content = render_template('templates/layout.php', ['page_content' => $page_content, 'title' => 'История просмотров', 'is_auth' => false, 'user_name' => $user_name, 'user_avatar' => $user_avatar, 'categories' => $categories]);
